...
Gộp 1 ViewSet nhiều action (kiểu `ChatController` của Laravel) — urls/public.py map
từng path vào từng action qua ``ChatViewSet.as_view({"post": "chat"})`` v.v.
...
from ._helpers import parse_pagination
